...
% [X, act_dip] = nip_simulate_activity(dip_pos, act_dip, act, dir, t, options)
% 
% Input:
...
%             J = zeros(3*Nd,1);
%             for i = 1:3
%                 J((act_dip-1)*3+i) = ones(length(act_dip),1);
%             end
%             nip_reconstruction3d(model.cortex, J, struct('colormap','gray','thres',0))
%             hold on
%             scatter3(0,-2.5,5,1000,'filled')
        end
