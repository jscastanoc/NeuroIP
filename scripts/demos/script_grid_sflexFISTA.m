...
spatial_reg = 100 ; % Sparsity in the spatial domain
...
er{1}= nip_all_errors(model.y,model.L,J_estsflexFISTA,J,model.cortex,actidx);

[J_estsflex, extras] = nip_sflex(model.y, L, B, 'optimres',true,'regpar',10,'resnorm', resnorm,'Winv',Winv);
% save('J_estsflex.mat','J_estsflex');
